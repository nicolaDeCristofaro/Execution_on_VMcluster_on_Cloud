...
![equation](https://latex.codecogs.com/png.image?\dpi{110}c&space;=&space;A&space;\cdot&space;x)
    where **c** is also a vector of length n and its element at index **i** is defined as:
 ![equation](https://latex.codecogs.com/png.image?\dpi{110}c[i]&space;=&space;&space;\sum_{j=0}^{n-1}&space;A[i,j]&space;\cdot&space;x[j])
