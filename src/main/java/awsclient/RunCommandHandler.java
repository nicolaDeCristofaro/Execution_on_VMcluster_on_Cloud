...
public class RunCommandHandler {
	...
	protected void buildProjectOnVMCluster(String bucketName, String projectName, String queueUrl, String mainClass) throws InterruptedException, ExecutionException {
	...
	protected void launchExecutionOnVMCluster(ArrayList<String> objectInputsString, int numberOfFunctions, 
	...
	protected String checkForExecutionErrors(String bucketName) {
		...
		if(error != null && (error.contains("Exception") || error.contains("Error"))) return error;
		else return null;
	}

	protected void deleteDocumentsCommand() {
