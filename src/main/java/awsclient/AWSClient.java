...
public class AWSClient {
	...
	public void setupS3Bucket(String bucketName) {
		this.bucketName = s3Handler.createBucket(bucketName);
	}
	...
	public void downloadProjectOnVMCluster() throws InterruptedException {
		runCommandHandler.downloadExecutionFileOnVMCluster(this.bucketName, this.terminationQueueUrl);
	}

	public void buildProjectOnVMCluster(String mainClass) throws InterruptedException, ExecutionException {
		runCommandHandler.buildProjectOnVMCluster(this.bucketName, this.projectID, this.terminationQueueUrl, mainClass);
	}
	...
	public void launchExecutionOnVMCluster(ArrayList<String> objectInputsString, int numberOfFunctions, long idExec) throws InterruptedException, ExecutionException, IOException {
		runCommandHandler.deleteDocumentsCommand();
		runCommandHandler.launchExecutionOnVMCluster(objectInputsString, numberOfFunctions, this.bucketName, this.projectID, idExec, this.terminationQueueUrl);
	}
